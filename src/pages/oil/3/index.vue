...
const oil = ref({
  ...
  category: '食用油',
  company: '山东西王食品有限公司',
  description: '采用优质玉米，浓香压榨工艺，营养丰富，口感浓郁醇厚。',
  ...
  rawMaterial: '100%纯正玉米胚芽油',
  inspectionReports: [
    {
      title: '质量检测报告',
      description: '西王油好鲜生玉米胚芽油质量检测报告',
      image: '/reports/西王好鲜生玉米胚芽油5L/报告1.png',
      fullReport: '/reports/西王好鲜生玉米胚芽油5L/产品检测报告.pdf',
    },
    {
      title: '标签审核报告',
      description: '西王油好鲜生玉米胚芽油标签审核报告',
      image: '/reports/西王好鲜生玉米胚芽油5L/报告2.png',
      fullReport: '/reports/西王好鲜生玉米胚芽油5L/产品检测报告.pdf',
    },
  ],
  storageMethod: '请将菜籽油存放在阴凉干燥处，避免阳光直射。开封后建议在3个月内食用完毕，以保证最佳品质。',
  usageTips: [
    '适合各种烹饪方式，特别适合煎炒、炖煮等高温烹饪。',
    '低芥酸特性使其更适合长期食用，营养更均衡。',
    '开盖后请及时盖紧瓶盖，避免油品氧化。',
    '可用于制作沙拉酱、蒜蓉酱等调味品，增添浓郁香味。',
  ],
})
