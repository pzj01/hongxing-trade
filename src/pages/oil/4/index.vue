...
const oil = ref({
  ...
  category: '食用油',
  company: '山东西王食品有限公司',
  description: '采用优质葵花籽，浓香压榨工艺，营养丰富，口感浓郁醇厚。',
  ...
  rawMaterial: '100%纯正葵花籽油',
  inspectionReports: [
    {
      title: '质量检测报告',
      description: '西王油葵花籽油质量检测报告',
      image: '/reports/西王葵花籽油5L（优选）/报告.png',
      fullReport: '/reports/西王葵花籽油5L（优选）/产品检测报告.pdf',
    },
  ],
