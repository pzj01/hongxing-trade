...
const oil = ref({
  ...
  rawMaterial: '100%纯正菜籽油，无添加',
  inspectionReports: [
    {
      title: '产品检测报告',
      description: '菜籽油出厂检测报告',
      image: '/reports/福禄花鲜香压榨菜籽油5L/报告.png',
      fullReport: '/reports/福禄花鲜香压榨菜籽油5L/产品检测报告.pdf',
    },
  ],
