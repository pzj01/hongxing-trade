...
const productionSteps = reactive([
  {
    ...
    completed: true,
    showDetails: false,
    details: '从优质菜籽供应商处采购新鲜菜籽，进行严格筛选以确保原料质量。',
    qualityChecks: ['菜籽品质检查', '含水量测试', '杂质含量评估'],
  },
  {
    name: '清洗与烘干',
    date: '2023-05-10',
    completed: true,
    showDetails: false,
    details: '使用专业设备对菜籽进行彻底清洗，然后进行低温烘干处理。',
    qualityChecks: ['清洗效果检查', '烘干后含水量测试', '杂质去除率评估'],
  },
  {
    name: '压榨',
    date: '2023-05-15',
    completed: true,
    showDetails: false,
    details: '采用先进的低温压榨技术，最大程度保留菜籽油的营养成分和原始风味。',
  ...
  },
  {
    ...
    qualityChecks: ['过滤效果检查', '酸值测定', '过氧化值检测'],
  },
  {
    name: '灌装',
    date: '2023-05-25',
