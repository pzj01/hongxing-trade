...
export interface Product {
  ...
  material_ids?: number[]
  testReport?: string
  raw_material_path?: string
  production_process_path?: string
}
...
export const products: Product[] = [
  ...
  },
  {
    ...
    raw_material_path: '/oil/1',
    production_process_path: '/oil/1/process',
  },
  {
    id: 9,
    name: '西王油低芥酸浓香菜籽油5L',
    ...
    raw_material_path: '/oil/2',
    production_process_path: '/oil/2/process',
  },
  {
    id: 10,
    name: '西王油好鲜生玉米胚芽油5L',
    ...
    raw_material_path: '/oil/3',
    production_process_path: '/oil/3/process',
  },
  // {
  //   id: 11,
  //   name: '西王油经典玉米胚芽油5L',
  ...
  // },
  {
    ...
    raw_material_path: '/oil/4',
    production_process_path: '/oil/4/process',
  },
  {
    id: 13,
    name: '西王油食用植物调和油5L（玉橄）',
    desc: '西王食用油，源自山东西王食品有限公司的匠心之作，专为追求健康与美味的家庭打造。精选优质原料，采用先进的物理压榨工艺，最大程度保留了油品的天然营养与纯正风味。',
    category: Category.OIL,
    price: 148,
    unit: '桶',
